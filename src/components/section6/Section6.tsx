    ...
    <div className='relative w-full min-h-screen gap-4 flex flex-col-reverse md:grid md:grid-cols-12 justify-center items-center'>
        <div className='w-full h-full flex flex-col gap-4 md:col-start-1 md:col-end-7'>
            <Transition delay={0.5} x={-50} stiffness={30}>
                ...
                <Image className='w-32' src='/img/section6/section61.png' alt='section61' width={900} height={900} quality={100} />
                <Image className='w-32' src='/img/section6/section62.png' alt='section62' width={900} height={900} quality={100} />
                </div>
            </Transition>
        </div>
        <div className='w-full overflow-hidden md:col-start-7 md:col-end-13 md:place-items-center'>
            <Transition delay={0.5} x={50} stiffness={30}>
            <Image className='scale-150 w-full flex justify-center items-center' src='/img/section6/section63.png' alt='section63' width={900} height={900} quality={100} />
            </Transition>
        </div>
    </div>
  )
